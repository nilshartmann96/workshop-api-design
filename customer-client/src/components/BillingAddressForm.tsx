...
export default function BillingAddressForm({
  ...
  const form = useForm({
    defaultValues: {
      ...
      streetName: initialAddress?.street?.streetName || '',
      houseNumber: initialAddress?.street?.houseNumber || '',
      zipCode: initialAddress?.city?.zipCode || '',
      cityName: initialAddress?.city?.cityName || '',
    },
